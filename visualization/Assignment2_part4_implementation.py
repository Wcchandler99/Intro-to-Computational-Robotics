...
def compute_arm_path(start_configuration, final_configuration, obstacles, alpha, eta, rho_0, steps=100, learning_rate=0.1, tolerance=1e-5):
...
visualize_arm_path(initial_configuration, final_configuration, obstacles, alpha, eta, rho_0)
